...
class Block(nn.Module):
    def __init__(self, num_layers, in_channels, out_channels, identity_downsample=None, stride=1):
        assert num_layers in [10, 18, 25, 34, 50, 75, 101, 152], "should be a a valid architecture"
...
class ResNet(nn.Module):
    def __init__(self, num_layers, block, image_channels, num_classes):
        assert num_layers in [10, 18, 25, 34, 50, 75, 101,
...
def ResNet10(img_channels=3, num_classes=10):
    return ResNet(10, Block, img_channels, num_classes)
...
def ResNet25(img_channels=3, num_classes=10):
    return ResNet(25, Block, img_channels, num_classes)
...
def ResNet75(img_channels=3, num_classes=10):
    return ResNet(75, Block, img_channels, num_classes)
