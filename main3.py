...
model = ResNet10(img_channels=3, num_classes=10)
print(model)
...
epochs = 111
epoch = 0
checkpoint = torch.load('//home/pc/PycharmProjects/LAB_08/checkpoints/chk_3_110.pth')
